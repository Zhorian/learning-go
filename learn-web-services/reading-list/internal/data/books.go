...
type Book struct {
	...
	Pubished  int       `json:"published,omitempty"`
...
func (b BookModel) Insert(book *Book) error {
	...
	args := []interface{}{book.Title, book.Pubished, book.Pages, pq.Array(book.Genres), book.Rating}
...
func (b BookModel) Update(book *Book) error {
	...
	args := []interface{}{book.Title, book.Pubished, book.Pages, pq.Array(book.Genres), book.Rating, book.ID, book.Version}
